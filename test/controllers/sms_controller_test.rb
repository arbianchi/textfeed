...
class SmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sm" do
    assert_difference('Sm.count') do
      post sms_url, params: { sm: { body: @sm.body, from: @sm.from, received_at: @sm.received_at } }
    end
  ...
  test "should update sm" do
    patch sm_url(@sm), params: { sm: { body: @sm.body, from: @sm.from, received_at: @sm.received_at } }
